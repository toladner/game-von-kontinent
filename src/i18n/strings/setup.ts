...
export const SETUP = {
  ...
  'setup.hours': { de: '{n} Std', en: '{n} hrs' },
  'setup.pace.minutes': { de: 'Atlantik in {n} Min', en: 'Atlantic in {n} min' },
  'setup.pace.hours': { de: 'Atlantik in {n} Std', en: 'Atlantic in {n} hrs' },
  'setup.aWeek': { de: 'eine Woche', en: 'a week' },
  'setup.days': { de: '{n} Tage', en: '{n} days' },
  ...
  'setup.summary.realtime': {
    de: 'Echtzeit · {pace} Min je Punkt · {hours} Std Saison',
    en: 'Real time · {pace} min per mark · {hours} hrs season',
  },
